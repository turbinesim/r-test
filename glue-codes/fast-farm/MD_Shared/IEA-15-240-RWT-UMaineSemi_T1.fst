...
---------------------- INPUT FILES --------------------------------------------- 
"IEA-15-240-RWT-UMaineSemi_ElastoDynT1.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string) 
...
"IEA-15-240-RWT-UMaineSemi_HydroDynT1.dat"      HydroFile       - Name of file containing hydrodynamic input parameters (quoted string) 
