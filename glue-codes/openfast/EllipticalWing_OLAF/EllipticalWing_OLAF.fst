...
Elliptical wing test case for OLAF free vortex wake in AeroDyn
---------------------- SIMULATION CONTROL --------------------------------------
...
"Elliptic_AeroDyn_40.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
