...
Based on FAST Certification Test #18: NREL 5.0 MW Baseline Wind Turbine (Onshore) with AeroDisk
---------------------- SIMULATION CONTROL --------------------------------------
...
---------------------- FEATURE SWITCHES AND FLAGS ------------------------------
          ...
          3   CompElast       - Compute structural dynamics (switch) {1=ElastoDyn; 2=ElastoDyn + BeamDyn for blades; 3=Simplified ElastoDyn}
...
---------------------- INPUT FILES ---------------------------------------------
"NREL_5MW_Simplified-ElastoDyn.dat"    EDFile          - Name of file containing ElastoDyn/Simplified-ElastoDyn input parameters (quoted string)
